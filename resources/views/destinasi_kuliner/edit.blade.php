    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12">
            ...
            <div class="card">
                ...
                @endif
                <form action="{{ route('destinasi-kuliner.update', ['id' => $destinasiKuliner->id]) }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                        <label for="nama">Nama Destinasi Kuliner</label>
                        <input type="text" name="nama" id="nama" class="form-control" value="{{ $destinasiKuliner->nama }}" required>
                    </div>
                    <div class="form-group">
