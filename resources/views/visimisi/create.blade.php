<!-- resources/views/visimisi/create.blade.php -->
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Add Data Deskripsi Kabupaten') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('visimisi.store') }}">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="geografis" name="geografis"
                                ...
                                required>{{ old('geografis') }}</textarea>
                            @error('geografis')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
