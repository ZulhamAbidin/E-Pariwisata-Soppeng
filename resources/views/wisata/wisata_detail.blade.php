...
@section('container')
    <div class="main-content app-content mt-4" id="">
        ...
        <div class="row">
            ...
            <div class="col-xl-7">
                <div class="card mt-6">
                    <img class="card-img-top mt-6" src="{{ asset('storage/' . $destinasiWisata->sampul) }}" alt="Card image cap">
                    <div class="card-body">
                        <div class="d-md-flex">
                            ...
                            <div class="media-body overflow-visible">
                                <div class="border mb-5 p-4 br-5">
                                    ...
                                    <form method="POST" style="display: none;" class="comment-form mt-4"
                                        ...
                                        action="{{ route('pengunjung.destinasi.tambah-balasan-komentar', ['destinasiWisata' => $destinasiWisata->id, 'komentar' => $komentar->id]) }}">
                                        @csrf
