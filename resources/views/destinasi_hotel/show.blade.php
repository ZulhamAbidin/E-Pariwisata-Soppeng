                ...
                <div class="row row-sm">
                                ...
                                <div class="product-carousel">
                                    <div id="Slider" class="carousel slide border" data-bs-ride="false">
                                        <div class="carousel-inner">
                                            ...
                                            <div class=""> <img src="{{ url('storage/' . $destinasihotel->sampul) }}" alt="img"
                    ...
                    <div class="details col-xl-7 col-lg-12 col-md-12 mt-4 mt-xl-0">
                        <div class="mt-2 mb-4">
                            ...
                            <p class="fw-bold text-success fw-bold text-justify">{{ $destinasihotel->Deskripsi }}</p>
                            
                            <div class=" mt-4 mb-5"><span class="fw-bold me-2">Jam Buka :</span><span class="fw-bold text-success">{{ $destinasihotel->JamBuka }}</span></div>
                            ...
                            <div class="">
                                ...
                                <a href="https://www.google.com/maps?q={{ $destinasihotel->latitude }},{{ $destinasihotel->longitude }}"  target="_blank" class="btn btn-primary block">Buka di Google Maps</a>
                        </div>
                    </div>
                </div>
            </div>
