                            ...
                            <div class="top-footer">
                                <div class="row">
                                    <div class="col-lg-4 col-sm-12 col-md-12 reveal revealleft">
                                        <h6>About</h6>
                                        <p>Selamat datang di sistem informasi pariwisata! Sistem ini berisi informasi tentang destinasi kuliner, wisata, hotel, dan
                                ...
                                <div class="row ">
                                    <div class="col-md-12 col-sm-12">
                                        Copyright © <span id="year"></span> <a
                                            href="javascript:void(0)"></a>.
                                        Designed with  by <a
                                            href="javascript:void(0)">  zlhm</a> All rights reserved.
                                    </div>
                                </div>
                            </footer>
                        </div>
