...
<body class="font-sans antialiased">
    <div class="container">
        ...
        @endif
        <form action="{{ route('destinasi-wisata.update', ['id' => $destinasiWisata->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
...
<script>
    var map;
        ...
        function initMap() {
            map = L.map('map').setView([initialLatitude, initialLongitude], 13); // Koordinat default dari data destinasi wisata yang akan diedit
